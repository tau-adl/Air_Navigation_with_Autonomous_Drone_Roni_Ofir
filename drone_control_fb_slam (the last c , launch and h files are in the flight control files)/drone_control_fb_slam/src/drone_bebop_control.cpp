...
void droneBebopControl::run()
{
  ...
  while (ros::ok())
  {
    ...
    // desired_angular_velocity_ = (1.0 - alp0;//
    
#if 0  // Naive navigation:
    //cmd_velocity_.linear.x = (pos_command_x - (position_x - position_x_0))*Kp_pos_x;
    //cmd_velocity_.linear.y = (pos_command_y - (position_y - position_y_0))*Kp_pos_y;
#endif
    ...
    //cmd_velocity_.linear.x = 0;    //desired_forward_velocity_;
    //cmd_velocity_.linear.y = 0;
